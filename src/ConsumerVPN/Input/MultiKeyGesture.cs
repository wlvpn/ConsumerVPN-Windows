...
namespace WLVPN.Input
{
    ...
    public class MultiKeyGesture : InputGesture
    {
        ...
        public List<KeySequence> KeySequences { get; } = new List<KeySequence>();
        ...
        public MultiKeyGesture(string displayString, params KeySequence[] sequences)
        {
            ...
            KeySequences.AddRange(sequences);
        }
        ...
        {
            if (inputEventArgs as KeyEventArgs == null || (inputEventArgs as KeyEventArgs).IsRepeat)
                return false;

            var key = (inputEventArgs as KeyEventArgs).Key != Key.System ? (inputEventArgs as KeyEventArgs).Key : (inputEventArgs as KeyEventArgs).SystemKey;
            ...
            if (currentSequence.Modifiers != (inputEventArgs as KeyEventArgs).KeyboardDevice.Modifiers)
            {
            ...
            if (currentKeyIndex == KeySequences[currentSequenceIndex].Keys.Count)
            {
            ...
            if (currentSequenceIndex != KeySequences.Count)
            {
