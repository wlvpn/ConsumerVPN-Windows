...
<xsl:stylesheet version="1.0"
  ...
  <xsl:key name="service-search" match="wix:Component[substring(wix:File/@Source, string-length(wix:File/@Source) - string-length('.exe') +1)='.exe' and not(contains(wix:File/@Source, 'OpenVPN') or contains(wix:File/@Source, 'WireGuard'))]" use="@Id" />
